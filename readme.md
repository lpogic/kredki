...
- In kredki directory you can find the gem source code. `rake` command always use this source, even if you have another _kredki_ version installed. Make the changes you need.

### API documentation:

Requirements:
- requirements for _Ruby files only_
- rdoc

Steps:
- steps for _Ruby files only_
