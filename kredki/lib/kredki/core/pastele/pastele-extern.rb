...
module Kredki
  module Pastele
    ...
    extern 'void window_get_maximum_size(pas::Window* self, IntPoint* point)'
    extern 'void window_set_opacity(pas::Window* self, float opacity)'
    extern 'float window_get_opacity(pas::Window* self)'
    ...
    extern 'const char* window_get_title(pas::Window* self)'
    ...
    extern 'void paint_set_transform(Paint* self, float pivot_x, float pivot_y, float x, float y, float a, float magx, float fy)'
