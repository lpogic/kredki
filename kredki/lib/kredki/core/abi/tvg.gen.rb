...
module Kredki
  module Abi
    ...
    extern 'void window_get_position(pas::Window* self, IntPoint* point)'
    extern 'void window_set_text_input(pas::Window* self, int input)'
    ...
    extern 'void paint_set_transform(Paint* self, float pivot_x, float pivot_y, float x, float y, float a, float scale_x, float scale_y)'
    ...
    extern 'void shape_append_rect1(Shape* self, float x, float y, float w, float h, float rbb, float rbe, float reb, float ree)'
    ...
    extern 'void scene_push(Scene* self, Paint* paint, Paint* at)'
