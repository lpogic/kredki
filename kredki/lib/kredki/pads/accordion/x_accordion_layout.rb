module Kredki
  module Pads
    module Accordion
      class XAccordionLayout < Layout::XWay
          ...
          if total_size > lower_size
            ...
            begin
              ...
              loop do
                ...
                limit = characteristic.pad.size_x_limit
                min = case limit
                when Range
                  limit.begin&.then{|it| characteristic.pad.get_size_x_value it, lower_size, nil } || 0
                else
                  0
                end.floor
        ...
        def arrange pad
          ...
          layoutic_pads.last&.set_size_x Auto
          pad_size_characteristics = layoutic_pads.map{|it| get_size_characteristic it, it.size_x, it.size_x_limit, csx }
        ...
        def arrange_pads pads, sx, csx, csy, spacer
          ...
          pads.each do |p1|
            if !p1.layoutic
              arrange_non_layoutic p1, each.next, csy
            end
          end
