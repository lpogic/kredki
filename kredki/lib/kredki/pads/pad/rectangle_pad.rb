module Kredki
  module Pads
    ...
    class RectanglePad < ShapePad
      ...
      def set_corner_ss corner_ss = @area.corner_ss, clip_corner = :auto
        ...
        if clip_corner == :auto
          ...
          @clip_area.set_corner_ss clip_corner
        end
      end
      ...
      # Set X start Y start corner.
      def set_corner_es corner_es = @area.corner_es, clip_corner = :auto
        ...
        if clip_corner == :auto
          ...
          @clip_area.set_corner_es clip_corner
        end
      end
      ...
      # Set X start Y start corner.
      def set_corner_se corner_se = @area.corner_se, clip_corner = :auto
        ...
        if clip_corner == :auto
          ...
          @clip_area.set_corner_se clip_corner
        end
      end
      ...
      # Set X start Y start corner.
      def set_corner_ee corner_ee = @area.corner_ee, clip_corner = :auto
        ...
        if clip_corner == :auto
          ...
          @clip_area.set_corner_ee clip_corner
        end
      end
      ...
      # Set X start Y start corner.
      def set_corner_xs corner_ss = @area.corner_ss, corner_se = corner_ss, clip_corner = :auto
        return send_bundle :set_corner_xs, yield(self.corner_xs) if block_given?
        set_corner_ss(corner_ss, clip_corner) | set_corner_se(corner_se, clip_corner)
      end
      ...
      # Set X start Y start corner.
      def set_corner_xe corner_es = @area.corner_es, corner_ee = corner_es, clip_corner = :auto
        return send_bundle :set_corner_xe, yield(self.corner_xe) if block_given?
        set_corner_es(corner_es, clip_corner) | set_corner_ee(corner_ee, clip_corner)
      end
      ...
      # Set X start Y start corner.
      def set_corner_ys corner_ss = @area.corner_ss, corner_es = corner_ss, clip_corner = :auto
        return send_bundle :set_corner_ys, yield(self.corner_ys) if block_given?
        set_corner_ss(corner_ss, clip_corner) | set_corner_es(corner_es, clip_corner)
      end
      ...
      # Set X start Y start corner.
      def set_corner_ye corner_se = @area.corner_se, corner_ee = corner_se, clip_corner = :auto
        return send_bundle :set_corner_ye, yield(self.corner_ye) if block_given?
        set_corner_se(corner_se, clip_corner) | set_corner_ee(corner_ee, clip_corner)
      end
      ...
      # Set corner.
      def set_corner corner = @area.corner_ss, clip_corner = :auto, **ka
        return send_bundle :set_corner, yield(self.corner) if block_given?
        set_corner_ss(corner, clip_corner) | 
        set_corner_es(corner, clip_corner) |
        set_corner_se(corner, clip_corner) |
        set_corner_ee(corner, clip_corner) |
